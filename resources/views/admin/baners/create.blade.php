                    ...
                    <div class="row">
                        ...
                        <div class="add-edit-product-wrap col-12">
                            ...
                            <div class="add-edit-product-form">
                                <form method="POST" action="{{ route('admin.baners.store') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <h4 class="title">اضف بيانات صور البانر</h4>
                                    ...
                                    <label class="text-lg col-lg-1"  for="image"> اضف الصوره اللتي ستظهر فالبانر</label>
