                            ...
                            <div class="add-edit-product-form">
                                <form method="POST" action="{{ route('admin.categories.update',$category->id) }}"
                                    ...
                                    <div class="row flex flex-wrap ">
                                        ...
                                        <div class="col-lg-4 col-12  mb-30"><input class="form-control" name="name_ar"
                                                id="name" type="text" value="{{$category->getTranslation('name','ar')}}" ="العنوان"></div>

                                    <label class="text-lg col-lg-1"  for="image"> القسم بالعربى</label>
                                    <br><br>
                                        <div class="col-lg-4 col-12  mb-30"><input class="form-control" name="name_en"
                                                id="name" type="text"value="{{$category->getTranslation('name','en')}}"  placeholder="العنوان"></div>

                                    <label class="text-lg col-lg-1"  for="image"> القسم بالانجليزى</label>
                                    <br><br>
