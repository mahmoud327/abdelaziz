                    ...
                    <div class="row">
                        ...
                        <div class="add-edit-product-wrap col-12">
                            ...
                            <div class="add-edit-product-form">
                                <form method="POST" action="{{ route('admin.contects.store') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <h4 class="title">اضف بيانات جهات الاتصال</h4>

                                    <div class="row flex flex-wrap ">

                                        <div class="col-lg-4 col-12  mb-30"><input class="form-control" name="name"
                                                id="name" type="text" placeholder="اسم وسيلة الاتصال"></div>

                                                <div class="col-lg-4 col-12  mb-30"><input class="form-control" name="description"
                                                    id="name" type="number" placeholder="ادخل الرقم"></div>
                                    ...
                                    {{-- <div class="col-12 mb-30">
                                        <textarea class="form-control mt-8" name="description" id="editor" placeholder="اكتب الرقم"></textarea>
                                    </div> --}}
