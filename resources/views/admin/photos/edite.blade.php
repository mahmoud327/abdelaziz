                    ...
                    <div class="row">
                        ...
                        <div class="add-edit-product-wrap col-12">
                            ...
                            <div class="add-edit-product-form">
                                <form method="POST" action="{{ route('admin.photos.update', $photos->id)}}"
                                    ...
                                    <div class="row flex flex-wrap ">
                                        ...
                                        <div class="col-lg-4 col-12  mb-30"><input class="form-control" name="name"
                                                id="name" type="text" value="{{$photos->name}}" placeholder="العنوان"></div>

                                    <label class="text-lg"  for="image">يلزم تغيير الصوره</label>
                                    <div>
                                        <img class="w-90 h-85" src="{{ Storage::url($photos->image)}}" alt="image">
                                    </div>
                                    ...
                                    <div class="col-12 row-50 mb-30">
                                        <textarea class="form-control mt-8" name="description" id="editor" placeholder="{!! $photos->description !!}  "></textarea>
                                    </div>
